...
- una funzione `main` che legge una sequenza di parole da standard input fino a incontrare la parola "stop", analizza una parola alla volta utilizzando la funzione `contaCifre` (vedi sotto) e alla fine stampa:
...
Nota. Le parole in input possono contenere caratteri di qualsiasi tipo (cifre, lettere, simboli, punteggiatura, lettere accentate, ecc.).
